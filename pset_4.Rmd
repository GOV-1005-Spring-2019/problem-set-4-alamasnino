...
```
There were `dem_support` respondents who supported the Dem. candidate.

There were `rep_support-und_support` more respondents who favored the Republican candidate than who were Undecided.

There are two gender variables (gender and gender_combined). There are `gender_difference[1]` individuals for whom these variables have different values.

There are `white_difference[1]` respondents listed as “White” under race_eth who are not listed as “White” under file_race_black.

The first response of Rep came `first_rep_response-first_dem_response` minutes (rounded to the nearest minute) before the first response of Dem.
## Including Plots
